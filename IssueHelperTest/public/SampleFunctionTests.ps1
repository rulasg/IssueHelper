...
function IssueHelperTest_GetPublicString{ 
...
function IssueHelperTest_GetPrivateString {

    $testedModulePath =  $TESTED_MODULE_PATH | Join-Path -ChildPath "IssueHelper.psd1"
...
Export-ModuleMember -Function IssueHelperTest_*
